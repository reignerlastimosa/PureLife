        ...
        <div className="whole">
           ...
           <div className="body"> 
            ...
            <div className="info">
                ...
                <input type="text" placeholder="search supplier"  onChange={search}/>
            ...
            {searchQuery === "" ? ( 
                appointment.map(app=>(
                            ...
                            <tr key={app.appointment_id}>
                                ...
                                <td className="action"> 
                                <Link to={"/doctor/edit/appointment/" + app.appointment_id}><button>Edit</button></Link>  
                ...
                filteredPatient.length > 0 ? (
                    filteredPatient.map((filteredNames) => (
                      <tr key={filteredNames.appointment_id}>
                        ...
                        <td className="action"> 
                                <button><Link to={"/doctor/edit/appointment/" + filteredNames.appointment_id}>  Edit  </Link></button>
